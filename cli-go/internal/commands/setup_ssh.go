...
import (
	...
	"github.com/joacohbc/my-devcontainer-installer/cli-go/internal/infra/containerpicker"
	...
	"github.com/joacohbc/my-devcontainer-installer/cli-go/internal/infra/ui"
...
func resolveTargetService(f *setupSshFlags) (composeServiceInfo, error) {
	...
	if services == nil {
		...
		picked, err := containerpicker.PickManaged("Select devcontainer to set up SSH for:", containerpicker.PickOptions{
