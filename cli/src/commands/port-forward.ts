...
export const portForwardCommand: Command<PortForwardConfig> = {
  name: 'port-forward',
  summary: 'Forward host port to a container port using SSH',
  parse: parsePortForwardFlags,
  help: portForwardHelp,
  run: runPortForward,
};
