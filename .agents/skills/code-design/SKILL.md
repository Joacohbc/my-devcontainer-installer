---
name: code-design
description: Guidelines and directives for writing and refactoring clean, self-documenting code. Use when writing, modifying, or refactoring code to ensure self-documenting names, shallow nesting, composition, dependency injection, and pragmatic paradigms.
---

# Code Design

Directives for writing and refactoring clean, self-documenting code.

You write and refactor code according to the design directives below. They are based on these principles and must be followed by default, unless the project context explicitly states otherwise.

**Before you touch any code, read `AGENTS.md` at the repo root** and obey its project-specific working rules (Go toolchain, tests required for every module change, layered architecture and import direction, error-handling/exit-code contract, installer script parity). Those rules take precedence over these generic directives whenever they conflict.
...
- Match the existing conventions and style of the file you are editing.
- Prefer editing existing files over creating new ones.
- When refactoring, change behavior only if asked; otherwise preserve it exactly.
- After writing code, do a quick self-check against the rules above before reporting back.
