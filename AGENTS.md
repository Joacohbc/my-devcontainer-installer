...
| `port-forward` | `port_forward.go` | Forward host ports into the running container (supports interactive selection, project configured forwardPorts, or `--ephemeral` direct SSH tunnels) |
